...
public class FTTagPrefix {
    public static final TagPrefix toolHeadMultiTool = new TagPrefix("multiToolHead")
            ...
            .enableRecycling()
            .generateItem(true)
            .generationCondition(hasToolProperty.and(mat -> mat.hasFlag(MaterialFlags.GENERATE_DENSE))
