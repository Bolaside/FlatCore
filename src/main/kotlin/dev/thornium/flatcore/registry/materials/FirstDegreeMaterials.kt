...
/** First-degree materials: built directly from vanilla/GT components, no FlatCore materials as inputs. */
object FirstDegreeMaterials {
    val FULL_METAL: List<MaterialFlag> = buildList {
        addAll(EXT2_METAL)
        add(GENERATE_FOIL)
        add(GENERATE_FRAME)
        add(GENERATE_GEAR)
    ...
    data class Registered(
        val redBrass: Material,
        val azuron: Material,
        val constantan: Material,
        val pigIron: Material,
        val vitreloy105: Material,
        val galliumNitrate: Material,
        val gallium3Oxide: Material,
    )

    fun register(): Registered {
        val redBrass = Material.Builder(FlatCore.id("red_brass"))
        ...
        val azuron = Material.Builder(FlatCore.id("azuron"))
        ...
        val constantan = Material.Builder(FlatCore.id("constantan"))
        ...
        val pigIron = Material.Builder(FlatCore.id("pig_iron"))
        ...
        val vitreloy105 = Material.Builder(FlatCore.id("vitreloy_105"))
            .dust().ingot(4).fluid()
        ...
        val galliumNitrate = Material.Builder(FlatCore.id("gallium_nitrate"))
            .dust()
        ...
        val gallium3Oxide = Material.Builder(FlatCore.id("gallium_iii_oxide"))
        ...
        return Registered(redBrass, azuron, constantan, pigIron, vitreloy105, galliumNitrate, gallium3Oxide)
    }
}
